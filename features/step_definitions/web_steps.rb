...
When /^(.*) within ([^:]+)$/ do |my_step, parent|
  with_scope(parent) { step my_step }
end

# Multi-line step scoper
When /^(.*) within ([^:]+):$/ do |my_step, parent, table_or_string|
  with_scope(parent) { step "#{my_step}:", table_or_string }
end
